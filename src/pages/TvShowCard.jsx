  ...
  return (
    <div className="flex flex-col items-center relative group">
              ...
              <div className="absolute w-full h-[600px] bg-gradient-to-r from-black"></div>
                <img
                  className="w-[500px] h-[400px] object-contain p-5 -mb-10 cursor-pointer"
              ...
              <div className="w-[500px] absolute top-[150px] transition-all transform translate-y-8 opacity-0 group-hover:opacity-100 group-hover:translate-y-0 ">
                <p className="text-white text-xl texxt-bold text-center">
                  {show.name}
                </p>
                <p className="px-16 text-white text-center opacity-60">
